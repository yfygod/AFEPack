...
void HGeometry<1,DOW>::refine()
{
  ...
  AssertExc(new_point != NULL, "out of memory.");
  if (mid_point == NULL) {
  ...
  AssertExc(child[0] != NULL, "out of memory.");
  child[0]->parent = this;
  ...
  AssertExc(child[1] != NULL, "out of memory.");
  child[1]->parent = this;
...
void HGeometry<2,DOW>::refine()
{
  ...
  for (i = 0;i < 3;i ++) {
    ...
    AssertExc(new_edge[i] != NULL, "out of memory.");
  ...
  for (i = 0;i < 3;i ++) {
    ...
    AssertExc(child[i] != NULL, "out of memory.");
    child[i]->parent = this;
  ...
  AssertExc(child[3] != NULL, "out of memory.");
  child[3]->parent = this;
...
void HGeometry<3,DOW>::refine()
{
	...
	
  {
	...
	break;
    AssertExc (start < 3,"internal error.");
    if (boundary[0]->vertex[ii[start+1]] == vertex[2])
      step = 1;
    else {
      AssertExc(boundary[0]->vertex[ii[start+1]] == vertex[3], "internal error.");
      AssertExc(boundary[0]->vertex[ii[start+2]] == vertex[2], "internal error.");
      step = 2;
    }
    ...
    if (boundary[1]->vertex[ii[start+1]] == vertex[2])
      ...
      AssertExc(boundary[1]->vertex[ii[start+1]] == vertex[3], "internal error.");
      AssertExc(boundary[1]->vertex[ii[start+2]] == vertex[2], "internal error.");
      step = 2;
    }
    AssertExc(edge_midpoint[3] == boundary[1]->boundary[start]->child[0]->vertex[1], "internal error.");
    ...
    if (boundary[2]->vertex[ii[start+1]] == vertex[1])
      ...
      AssertExc(boundary[2]->vertex[ii[start+1]] == vertex[3], "internal error.");
      AssertExc(boundary[2]->vertex[ii[start+2]] == vertex[1], "internal error.");
      step = 2;
    }
    AssertExc(edge_midpoint[4] == boundary[2]->boundary[start]->child[0]->vertex[1], "internal error.");
    AssertExc(edge_midpoint[2] == boundary[2]->boundary[ii[start+step]]->child[0]->vertex[1], "internal error.");
    ...
    if (boundary[3]->vertex[ii[start+1]] == vertex[1])
      ...
      AssertExc(boundary[3]->vertex[ii[start+1]] == vertex[2], "internal error.");
      AssertExc(boundary[3]->vertex[ii[start+2]] == vertex[1], "internal error.");
      step = 2;
    }
    AssertExc(edge_midpoint[5] == boundary[3]->boundary[start]->child[0]->vertex[1], "internal error.");
    AssertExc(edge_midpoint[1] == boundary[3]->boundary[ii[start+step]]->child[0]->vertex[1], "internal error.");
    AssertExc(edge_midpoint[0] == boundary[3]->boundary[ii[start+2*step]]->child[0]->vertex[1], "internal error.");
  ...
  for (i = 0;i < 8;i ++) {
    ...
    AssertExc(triangle[i] != NULL, "out of memory.");
  }
  ...
  case REFINE_MODEL_03:
    ...
    AssertExc (axis != NULL, "out of memory.");
  ...
  default:
    AssertExc(false, "internal error.");
  }	
}
...
void HGeometry<2,DOW>::checkIntegrity() const
{
  ...
  for (i = 0;i < n_boundary;i ++) {
	...
	if (b->vertex[j] == vertex[k])
      ...
      AssertExc(k < n_vertex, "internal error.");
    }
  }
  if (!isRefined()) return;
  for (int i = 0;i < n_child;i ++) {
...
void IrregularMesh<1, DOW>::regularize(bool renumerate)
{
  ...
  AssertExc (regular_mesh != NULL, "out of memory.");
  ...
  for (;the_ele != end_ele;++ the_ele) {
    ...
    AssertExc(element.index() == -1, "internal error.");
#ifdef __SERIALIZATION__
...
void IrregularMesh<3, DOW>::regularize(bool renumerate)
{
  ...
  for (;the_ele != end_ele;++ the_ele) {
    ...
    AssertExc(tools.isGeometryActive(*h_element), "internal error.");
  ...
  for (;the_ele != end_ele;++ the_ele) {
	...
	AssertExc(n_nonactive_neighbour == 1, "internal error.");
    ...
    if (n_nonactive_neighbour == 1) { // 四胞胎的情形
      AssertExc((n_twin_triangle_surface == 3), "internal error.");
	...
	tetra.boundary(k+4) = h_element->boundary[t[k+1]]->index;
      ...
      AssertExc (n_twin_triangle_surface == 2, "internal error.");
      ...
      AssertExc ((refined_edge_idx >= 0), "internal error.");
      ...
      AssertExc((n_nonactive_neighbour == 0 && n_twin_triangle_surface == 0), "internal error.");
...
void RegularMesh<2, DOW>::writeEasyMesh(const std::string& filename) const
{
  ...
  for (i = 0;i < n_element;i ++) {
	...
	if (the_side.vertex(0) == the_ele.vertex(ii[j+1])) {
	  AssertExc(the_side.vertex(1) == the_ele.vertex(ii[j+2]), "internal error.");
	  side_neighbour[1][k] = i;
	}
	else if (the_side.vertex(0) == the_ele.vertex(ii[j+2])) {
	  AssertExc(the_side.vertex(1) == the_ele.vertex(ii[j+1]), "internal error.");
	...
	AssertExc(the_side_0.vertex(1) == the_ele.vertex(1), "internal error.");
	side_neighbour[1][k] = i;
      }
      else if (the_side_0.vertex(0) == the_ele.vertex(1)) {
	AssertExc(the_side_0.vertex(1) == the_ele.vertex(0), "internal error.");
	side_neighbour[0][k] = i;
      }
      else {
	AssertExc(false, "internal error.");
	...
	AssertExc(the_side_1.vertex(1) == the_ele.vertex(2), "internal error.");
	side_neighbour[1][k] = i;
      }
      else if (the_side_1.vertex(0) == the_ele.vertex(2)) {
	AssertExc(the_side_1.vertex(1) == the_ele.vertex(1), "internal error.");
	side_neighbour[0][k] = i;
      }
      else {
	AssertExc(false, "internal error.");
	...
	AssertExc(the_side_2.vertex(1) == the_ele.vertex(3), "internal error.");
	side_neighbour[1][k] = n_element + index[i];
      }
      else if (the_side_2.vertex(0) == the_ele.vertex(3)) {
	AssertExc(the_side_2.vertex(1) == the_ele.vertex(2), "internal error.");
	...
	AssertExc(the_side_3.vertex(1) == the_ele.vertex(0), "internal error.");
	side_neighbour[1][k] = n_element + index[i];
      }
      else if (the_side_3.vertex(0) == the_ele.vertex(0)) {
	AssertExc(the_side_3.vertex(1) == the_ele.vertex(3), "internal error.");
	side_neighbour[0][k] = n_element + index[i];
      }
      else {
	AssertExc(false, "internal error.");
...
void HGeometryTree<2, DOW>::readEasyMesh(const std::string& filename)
{
  ...
  for (i = 0;i < n_node;i ++) {
    ...
    AssertExc(node[i] != NULL, "out of memory.");
    is >> j
  ...
  is >> i;
  AssertExc(i == n_side, "internal error.");
  std::cerr << "\treading the sides data ..." << std::flush;	
  for (i = 0;i < n_side;i ++) {
    side[i] = new HGeometry<1, DOW>();
    AssertExc(side[i] != NULL, "out of memory.");
    is >> l >> j >> k;
  ...
  is >> i >> j >> k;
  AssertExc(i == n_element, "internal error.");
  AssertExc(j == n_node, "internal error.");
  AssertExc(k == n_side, "internal error.");
  is.getline(dummy, 64);
  std::cerr << "\treading the elements data ..." << std::flush;	
  for (i = 0;i < n_element;i ++) {
    element[i] = new HGeometry<2, DOW>();
    AssertExc(element[i] != NULL, "out of memory.");
    is >> l >> j >> k >> l;
