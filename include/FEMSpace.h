...
template <class value_type, int DIM, int DOW=DIM, int TDIM=DIM, typename Number=double>
  ...
  void writeOpenDXData(const std::string& filename,
	...
	void writeTecplotData(const std::string&,int) const;
	
	void writeTecplotData_Rectangle(const std::string& ,int) const;

	void writeMatlabData(const std::string&,const std::string&) const;
