...
#include "../bundled/matrix.h"
#include "../bundled/sparse_matrix.h"

#ifndef __SERIALIZATION__
#define __SERIALIZATION__
#endif

#ifndef AFEPACK_MULTITHREAD
#define AFEPACK_MULTITHREAD
#endif
...
void SetPrintInfo(bool);
bool IsPrintInfo();
void PrintFlagManager(int, bool *);
