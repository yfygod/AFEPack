/**
 * 将向量函数的 OpenDX 格式的数据文件转换为 Tecplot 格式的数据文件
 * 
 * 此文件为魏华祎同学提供
 */
...
typedef nVector<DIM,double> vec_t; 
