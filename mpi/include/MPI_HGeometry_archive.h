...
#ifndef __MPI_HGeometry_archive_h__
#define __MPI_HGeometry_archive_h__
    ...
    public:
      ...
      template <int DIM, int DOW>
        ...
        if (p_geo == NULL) { /// 空指针
          ...
          std::map<int,int> * p_map = lb().get_rank_map(*p_geo);
          if (lb().is_save_on_this_rank(p_map, new_rank())) {
...
#endif // __MPI_HGeometry_archive_h__
